...
class Channel {
    ...
    const ENDPOINTS = array(
        ...
        'messages' => array(
            ...
            'reactions' => [
                ...
                'deleteEmoji' => 'channels/%s/messages/%s/reactions/%s',
    ...
    {
        $url = \CharlotteDunois\Yasmin\HTTP\APIEndpoints::format(self::ENDPOINTS['messages']['reactions']['get'],
    ...
    {
        $url = \CharlotteDunois\Yasmin\HTTP\APIEndpoints::format(self::ENDPOINTS['messages']['reactions']['deleteAll'],
            $channelid, $messageid);
        return $this->api->makeRequest('DELETE', $url, []);
    }

    function deleteMessageReactionsForEmoji(string $channelid, string $messageid, string $emoji)
    {
        $url = \CharlotteDunois\Yasmin\HTTP\APIEndpoints::format(self::ENDPOINTS['messages']['reactions']['deleteEmoji'],
            $channelid, $messageid, $emoji);
        return $this->api->makeRequest('DELETE', $url, []);
    }
    ...
    {
        $url = \CharlotteDunois\Yasmin\HTTP\APIEndpoints::format(self::ENDPOINTS['permissions']['edit'], $channelid,
            $overwriteid);
    ...
    {
        $url = \CharlotteDunois\Yasmin\HTTP\APIEndpoints::format(self::ENDPOINTS['permissions']['delete'], $channelid,
            $overwriteid);
