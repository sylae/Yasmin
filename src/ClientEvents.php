...
interface ClientEvents {
    ...
    function guildMemberUpdate(
        \CharlotteDunois\Yasmin\Models\GuildMember $new,
        ?\CharlotteDunois\Yasmin\Models\GuildMember $old
    );
     ...
     * @return void
     */
    function inviteCreate(\CharlotteDunois\Yasmin\Models\Invite $invite);

    /**
     * Emitted when an invite is deleted
     * @return void
     */
    function inviteDelete(\CharlotteDunois\Yasmin\Interfaces\ChannelInterface $channel, string $messageID);
    ...
    function guildMembersChunk(
        \CharlotteDunois\Yasmin\Models\Guild $guild,
        \CharlotteDunois\Collect\Collection $members
    );
