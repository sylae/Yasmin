...
class Guild extends ClientBase {
    ...
    function _patch(array $guild)
    {
        ...
        $this->ownerID = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['owner_id'] ?? $this->ownerID),
            'string');
        ...
        $this->premiumTier = (isset($guild['premium_tier']) ? (self::PREMIUM_TIER[$guild['premium_tier']] ?? $this->premiumTier) : $this->premiumTier);
        $this->systemChannelID = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['system_channel_id'] ?? $this->systemChannelID),
            'string');

        $this->afkChannelID = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['afk_channel_id'] ?? $this->afkChannelID),
            'string');
        ...
        $this->maxPresences = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['max_presences'] ?? $this->maxPresences),
            'int');
        $this->maxMembers = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['max_members'] ?? $this->maxMembers),
            'int');
        $this->vanityInviteCode = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['vanity_url_code'] ?? $this->vanityInviteCode),
            'string');
        $this->description = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['description'] ?? $this->description),
            'string');
        $this->banner = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($guild['banner'] ?? $this->banner),
            'string');
