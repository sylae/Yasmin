 ...
 * @property Emoji|null                                              $emoji          The emoji of a custom status, or null.
...
class Activity extends ClientBase {
    ...
    function __construct(\CharlotteDunois\Yasmin\Client $client, array $activity) {
        ...
        $this->sessionID = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($activity['session_id'] ?? null),
            'string');
        $this->syncID = \CharlotteDunois\Yasmin\Utils\DataHelpers::typecastVariable(($activity['sync_id'] ?? null),
            'string');
    }
